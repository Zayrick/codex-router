...
//!
//! HTTP fetches, timers, cancellation, and persistence are implemented outside
//! `auth`; domain services depend only on these traits.
...
#[async_trait]
pub trait OAuthCredentialsStore: Send + Sync {
